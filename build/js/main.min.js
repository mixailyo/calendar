      ...
      activeIndexChange: function activeIndexChange() {
        ...
        if (document.documentElement.clientWidth > 767) {
          if ((this.activeIndex - 11) % 2 === 1) {
            ...
            setTimeout(function () {
              if (_this.activeIndex - 11 - 1 !== 10) {
                paginationBullets[_this.activeIndex - 11 - 1].classList.add("swiper-pagination-bullet-active");
              }
            }, 1);
          }
        }
    ...
    if (scrollItems.length) {
      var scrollAnimation = function scrollAnimation() {
        scrollItems.forEach(function (el) {
          ...
          if (el.getBoundingClientRect().top < elementPosY || el.getBoundingClientRect().top < document.documentElement.clientHeight / 2) {
